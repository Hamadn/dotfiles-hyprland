...
config.set(
    ...
    True,
    "file:///home/hamad/.local/share/qutebrowser/userscripts/*",
)
...
config.bind(
    "Z",
    "hint links spawn wezterm start youtube-dl -f bestvideo+bestaudio {hint-url}",
)
config.bind(
    "xx",
